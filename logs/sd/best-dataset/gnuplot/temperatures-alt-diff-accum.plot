...
plot \
	'../analysis-scripts/temp-a+THERMAL_STATE-12-0.csv' \
		using 'baro_altitude':'delta_t' \
		with lines ls 1 \
		axis x1y1 \
		title "АКБ-1" \
	,\
	'../analysis-scripts/temp-a+THERMAL_STATE-12-1.csv' \
		using 'baro_altitude':'delta_t' \
		with lines ls 2 \
		axis x1y1 \
		title "АКБ-2" \
	,\
	'../analysis-scripts/temp-a+THERMAL_STATE-12-2.csv' \
		using 'baro_altitude':'delta_t' \
		with lines ls 3 \
		axis x1y1 \
		title "АКБ-3" \
	,\
	'../analysis-scripts/temp-a+THERMAL_STATE-12-3.csv' \
		using 'baro_altitude':'delta_t' \
		with lines ls 4 \
		axis x1y1 \
		title "АКБ-4" \
