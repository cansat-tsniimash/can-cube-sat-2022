...
// MON-HW2 - Расширенное состояние аппаратуры
static const uint8_t cfg_msg_13[] = {
		0x06, 0x01, // msgid, clsid
		0x08, 0x00, // len
		0x0A, 0x0B, // msgid, clsid целевого сообщения
		// Дальше частоты этого сообщения на разных портах
		0x00, // 0 - ddc
		0x01, // 1 - uart <--- вот тут и нужно поставить 1 чтобы включилось
		0x00, // 2 - тоже uart? у нас такого вроде нет
		0x00, // 3 - usb
		0x00, // 4 - spi
		0x00  // 5 - чет знает что такое
};
//static const uint8_t cfg_msg_14[] = {0x06, 0x01, 0x08, 0x00, 0x0A, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
// MON-HW2 - Расширенное состояние аппаратуры
static const uint8_t cfg_msg_14[] = {
		0x06, 0x01, // msgid, clsid
		0x08, 0x00, // len
		0x0A, 0x09, // msgid, clsid целевого сообщения
		// Дальше частоты этого сообщения на разных портах
		0x00, // 0 - ddc
		0x01, // 1 - uart <--- вот тут и нужно поставить 1 чтобы включилось
		0x00, // 2 - тоже uart? у нас такого вроде нет
...
static const uint8_t cfg_msg_29[] = {
		0x06, 0x01, // msgid, clsid
		0x08, 0x00, // len
		0x01, 0x30, // msgid, clsid целевого сообщения
		// Дальше частоты этого сообщения на разных портах
		0x00, // 0 - ddc
		0x01, // 1 - uart <--- вот тут и нужно поставить 1 чтобы включилось
		0x00, // 2 - тоже uart? у нас такого вроде нет
...
static const uint8_t cfg_msg_34[] = {
		0x06, 0x01, // msgid, clsid
		0x08, 0x00, // len
		0x02, 0x20, // msgid, clsid целевого сообщения
		// Дальше частоты этого сообщения на разных портах
		0x00, // 0 - ddc
		0x01, // 1 - uart <--- вот тут и нужно поставить 1 чтобы включилось
		0x00, // 2 - тоже uart? у нас такого вроде нет
...
static const uint8_t cfg_msg_41[] = {
		...
		// Дальше частоты этого сообщения на разных портах
		0x00, // 0 - ddc
		0x00, // 1 - uart <--- вот тут и нужно поставить 1 чтобы включилось
		0x00, // 2 - тоже uart? у нас такого вроде нет
		0x00, // 3 - usb
		0x00, // 4 - spi
		0x00  // 5 - чет знает что такое
