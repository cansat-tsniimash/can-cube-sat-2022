...
#define MODEL_SPEED_UP ((4.2*1000.f)/(10*60)) // ~ 4км в 10 минут в м/c
...
#define MODEL_MAX_ALT (24*1000) // 24 км в м
// Минимальная высота
...
// k - задается здесь
#define MODEL_PUMP_COEFF_K (10)
// Постоянная часть наканчки помпы (коээфициент b из k(p - p_max) + b)
#define MODEL_PUMP_COEFF_B ((40*1000)/(1000/MODEL_TEAK_MS)) // тест показали при нормальном давлении ~46 кПа/с
...
// где p - текущее давление, p_outer - давление снаружи аппарата
#define MODEL_LEAK_COEFF_K (0.001)
